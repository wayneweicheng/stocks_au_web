...
This prompt was generated for `TSLA.US` with requested as-of date `2026-06-02` from a fresh SQL Server extraction for this ticker. Candidate rules and the feature-score gate were evaluated separately on `TomorrowChange`, `Next2DaysChange`, and `Next5DaysChange`. The selected primary target for this ticker is `Next2DaysChange` (next 2 trading days). This section is research metadata only; do not use it as today's market state during live or historical replay analysis.
...
- Daily feature rows: 838 total, 835 selected-target labeled rows from 2023-01-04 to 2026-05-28.
- Train split: 2023-01-04 to 2025-05-22, 584 rows.
- Validation split: 2025-05-23 to 2025-11-19, 125 rows.
...
- 2-day: feature-score test win 52.0%, coverage 25/126 (19.8%), selection rank value 522.41, accepted robust patterns 5.
- 5-day: feature-score test win 49.1%, coverage 55/125 (44.0%), selection rank value 495.85, accepted robust patterns 6.
- 1-day: feature-score test win 47.2%, coverage 36/126 (28.6%), selection rank value 475.06, accepted robust patterns 6.
- Baseline selected-target win rate: train 50.2%, validation 52.0%, test 50.0%.
- Baseline tomorrow win rate: train 52.0%, validation 52.8%, test 52.4%.
- Baseline 2-day win rate: train 50.2%, validation 52.0%, test 50.0%.
- Baseline 5-day win rate: train 51.4%, validation 54.4%, test 44.0%.
- Selective feature-score gate: threshold 0.50 on the trained probability score.
- Feature-score train performance on selected target: win 62.2%, coverage 294/584 (50.3%), avg selected return +1.801%.
- Feature-score validation performance on selected target: win 52.5%, coverage 59/125 (47.2%), avg selected return +0.792%.
- Feature-score test performance on selected target: win 52.0%, coverage 25/126 (19.8%), avg selected return +0.426%.
- Large option trade rows sampled: 1000.
- Latest OI-change records sampled: 100. Positive call OI change 178836; positive put OI change 51857; near-term call additions 157772; near-term put additions 41247.
- Top current OI records sampled: 50.
- 30-minute bars sampled: 128.
- Broad feature audit rules tested: 292 single-feature rules and 1 two-feature combinations.

### Accepted Patterns

- `SVix_DarkPoolIndex >= train_q90 (57.1)` (2-day): train n=55, avg +0.655%, win 58.2%; validation n=24, avg +0.485%, win 58.3%; test n=31, avg +0.540%, win 58.1%; test 1-day avg -0.231%, test 2-day avg +0.540%, test 5-day avg +0.148%.
- `SVix_DarkPoolIndex >= train_q90 (57.1) AND SVix_DarkPoolBuyRatio >= train_q90 (1.33)` (2-day): train n=55, avg +0.655%, win 58.2%; validation n=24, avg +0.485%, win 58.3%; test n=31, avg +0.540%, win 58.1%; test 1-day avg -0.231%, test 2-day avg +0.540%, test 5-day avg +0.148%.
- `SVix_DarkPoolBuyRatio >= train_q90 (1.33)` (2-day): train n=55, avg +0.655%, win 58.2%; validation n=25, avg +0.385%, win 56.0%; test n=31, avg +0.540%, win 58.1%; test 1-day avg -0.231%, test 2-day avg +0.540%, test 5-day avg +0.148%.
- `RSI >= train_q70 (64.76)` (2-day): train n=175, avg +1.728%, win 58.9%; validation n=23, avg +1.200%, win 60.9%; test n=25, avg +0.538%, win 56.0%; test 1-day avg +0.234%, test 2-day avg +0.538%, test 5-day avg +1.364%.
- `RSI >= train_q80 (71.51)` (2-day): train n=117, avg +1.761%, win 55.6%; validation n=17, avg +1.484%, win 58.8%; test n=8, avg +0.835%, win 50.0%; test 1-day avg +0.227%, test 2-day avg +0.835%, test 5-day avg +3.460%.
...
The model is intentionally selective. Historical test coverage was 25/126 (19.8%), which means many days did not qualify for a high-confidence forecast. In the live report, you must clearly label whether today's setup is inside or outside the validated high-confidence regime.
...
- `BB_PercentB`: model weight +0.3240
- `GEX_Percentile_High`: model weight +0.3144
- `GEX_ZScore_VeryHigh`: model weight -0.2984
- `GEX_BigDrop`: model weight +0.2764
- `TodayChange`: model weight -0.2726
- `GEX_Trending_Up`: model weight -0.2641
- `GEX_ZScore_60day`: model weight +0.2553
- `SVix_DarkPoolIndex`: model weight -0.2282
- `Prev10DaysChange`: model weight -0.2200
- `BB_Bandwidth`: model weight +0.2109
- `Setup_Dual_Squeeze`: model weight +0.2088
- `SVix_DarkPoolBuyRatio`: model weight +0.2086

### Rejected Or Downgraded Patterns

- `BB_PercentB >= train_q80 (0.8667)` (2-day): train n=103, avg +1.971%, win 61.2%; validation n=14, avg +1.173%, win 42.9%; test n=13, avg -0.897%, win 38.5%; test 1-day avg -0.753%, test 2-day avg -0.897%, test 5-day avg -2.600%.
- `BB_PercentB >= train_q90 (0.9747)` (2-day): train n=52, avg +1.790%, win 65.4%; validation n=6, avg +3.183%, win 66.7%; test n=5, avg -1.542%, win 40.0%; test 1-day avg -1.392%, test 2-day avg -1.542%, test 5-day avg -5.576%.
- `Prev2DaysChange >= train_q80 (4.484)` (2-day): train n=117, avg +1.669%, win 58.1%; validation n=21, avg -0.443%, win 42.9%; test n=12, avg -0.601%, win 50.0%; test 1-day avg -0.452%, test 2-day avg -0.601%, test 5-day avg -1.527%.
- `VIX >= train_q90 (21.98)` (2-day): train n=59, avg +1.422%, win 47.5%; validation n=5, avg +0.726%, win 40.0%; test n=26, avg -0.482%, win 46.2%; test 1-day avg -0.258%, test 2-day avg -0.482%, test 5-day avg -1.734%.
- `GEX_Positive = 1` (2-day): train n=116, avg +1.401%, win 50.0%; validation n=115, avg +0.080%, win 50.4%; test n=107, avg -0.130%, win 45.8%; test 1-day avg +0.004%, test 2-day avg -0.130%, test 5-day avg -0.098%.
- `Prev2DaysChange >= train_q70 (2.702)` (2-day): train n=175, avg +1.358%, win 57.1%; validation n=37, avg -0.126%, win 51.4%; test n=26, avg -1.324%, win 34.6%; test 1-day avg -0.838%, test 2-day avg -1.324%, test 5-day avg -2.513%.
...
#### SVix_DarkPoolIndex >= train_q90 (57.1)
- **Tier:** Tier 1
- **Signal:** Bullish for the next 2 trading days.
- **Historical Evidence:** `SVix_DarkPoolIndex >= train_q90 (57.1)` (2-day): train n=55, avg +0.655%, win 58.2%; validation n=24, avg +0.485%, win 58.3%; test n=31, avg +0.540%, win 58.1%; test 1-day avg -0.231%, test 2-day avg +0.540%, test 5-day avg +0.148%.
...
#### SVix_DarkPoolIndex >= train_q90 (57.1) AND SVix_DarkPoolBuyRatio >= train_q90 (1.33)
- **Tier:** Tier 1
- **Signal:** Bullish for the next 2 trading days.
- **Historical Evidence:** `SVix_DarkPoolIndex >= train_q90 (57.1) AND SVix_DarkPoolBuyRatio >= train_q90 (1.33)` (2-day): train n=55, avg +0.655%, win 58.2%; validation n=24, avg +0.485%, win 58.3%; test n=31, avg +0.540%, win 58.1%; test 1-day avg -0.231%, test 2-day avg +0.540%, test 5-day avg +0.148%.
- **Rationale:** Use this as an explainable stock-specific 2-day market-flow rule for TSLA. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** High; downgrade if current option flow strongly contradicts it.

#### SVix_DarkPoolBuyRatio >= train_q90 (1.33)
- **Tier:** Tier 2
- **Signal:** Bullish for the next 2 trading days.
- **Historical Evidence:** `SVix_DarkPoolBuyRatio >= train_q90 (1.33)` (2-day): train n=55, avg +0.655%, win 58.2%; validation n=25, avg +0.385%, win 56.0%; test n=31, avg +0.540%, win 58.1%; test 1-day avg -0.231%, test 2-day avg +0.540%, test 5-day avg +0.148%.
- **Rationale:** Use this as an explainable stock-specific 2-day market-flow rule for TSLA. Cross-check the other horizons for timing, confirmation, or conflict.
...
- **Tier:** Tier 2
- **Signal:** Bullish for the next 2 trading days.
- **Historical Evidence:** `RSI >= train_q70 (64.76)` (2-day): train n=175, avg +1.728%, win 58.9%; validation n=23, avg +1.200%, win 60.9%; test n=25, avg +0.538%, win 56.0%; test 1-day avg +0.234%, test 2-day avg +0.538%, test 5-day avg +1.364%.
- **Rationale:** Use this as an explainable stock-specific 2-day market-flow rule for TSLA. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** Medium; downgrade if current option flow strongly contradicts it.
...
- **Historical Test Coverage:** 25/126 (19.8%)
