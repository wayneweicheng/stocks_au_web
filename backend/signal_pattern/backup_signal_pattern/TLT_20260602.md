...
**Task:** Analyze the provided TLT market data to forecast price action over the next 5 trading days. The 1-day, 2-day, and 5-day horizons were all researched during prompt generation; the signal strength classification must be based primarily on the selected horizon because it had the highest held-out feature-score test win rate for this ticker. Coverage is reported as a reliability caveat, not as the target-selection winner.
...
This prompt was generated for `TLT.US` with requested as-of date `2026-05-26` from a fresh SQL Server extraction for this ticker. Candidate rules and the feature-score gate were evaluated separately on `TomorrowChange`, `Next2DaysChange`, and `Next5DaysChange`. The selected primary target for this ticker is `Next5DaysChange` (next 5 trading days). This section is research metadata only; do not use it as today's market state during live or historical replay analysis.
...
- Daily feature rows: 833 total, 826 selected-target labeled rows from 2023-01-04 to 2026-05-15.
- Train split: 2023-01-04 to 2025-05-12, 578 rows.
- Validation split: 2025-05-13 to 2025-11-10, 124 rows.
- Test split: 2025-11-11 to 2026-05-15, 124 rows.
...
- 5-day: feature-score test win 42.4%, coverage 59/124 (47.6%), selection rank value 428.31, accepted robust patterns 6.
- 1-day: feature-score test win 41.9%, coverage 62/125 (49.6%), selection rank value 424.27, accepted robust patterns 6.
- 2-day: feature-score test win 40.5%, coverage 42/125 (33.6%), selection rank value 408.10, accepted robust patterns 6.
- Baseline selected-target win rate: train 45.8%, validation 53.2%, test 39.5%.
- Baseline tomorrow win rate: train 50.3%, validation 49.2%, test 46.4%.
- Baseline 2-day win rate: train 45.7%, validation 53.2%, test 48.0%.
- Baseline 5-day win rate: train 45.8%, validation 53.2%, test 39.5%.
- Selective feature-score gate: threshold 0.50 on the trained probability score.
- Feature-score train performance on selected target: win 68.4%, coverage 225/578 (38.9%), avg selected return +0.754%.
- Feature-score validation performance on selected target: win 55.8%, coverage 52/124 (41.9%), avg selected return +0.214%.
- Feature-score test performance on selected target: win 42.4%, coverage 59/124 (47.6%), avg selected return -0.179%.
- Large option trade rows sampled: 1000.
- Latest OI-change records sampled: 100. Positive call OI change 409648; positive put OI change 45746; near-term call additions 78576; near-term put additions 20852.
- Top current OI records sampled: 50.
- 30-minute bars sampled: 160.
- Broad feature audit rules tested: 300 single-feature rules and 57 two-feature combinations.

### Accepted Patterns

- `GEX_Trending_Up = 0 AND Price_Above_SMA50 = 1` (5-day): train n=164, avg -0.370%, win 57.3%; validation n=31, avg -0.405%, win 67.7%; test n=8, avg -1.805%, win 100.0%; test 1-day avg -0.316%, test 2-day avg -0.801%, test 5-day avg -1.805%.
- `BuyCall_GEXDeltaPerc <= train_q40 (42.38) AND GEX_Trending_Up = 0` (5-day): train n=162, avg -0.455%, win 60.5%; validation n=17, avg -0.448%, win 64.7%; test n=14, avg -1.036%, win 85.7%; test 1-day avg -0.127%, test 2-day avg -0.239%, test 5-day avg -1.036%.
- `BuyCall_GEXDeltaPerc <= train_q30 (38.37) AND GEX_Trending_Up = 0` (5-day): train n=122, avg -0.704%, win 65.6%; validation n=13, avg -0.520%, win 69.2%; test n=10, avg -0.841%, win 80.0%; test 1-day avg -0.146%, test 2-day avg -0.364%, test 5-day avg -0.841%.
- `BuyCall_GEXDeltaPerc <= train_q30 (38.37) AND Price_Above_SMA50 = 1` (5-day): train n=89, avg -0.806%, win 65.2%; validation n=22, avg -0.399%, win 72.7%; test n=7, avg -0.883%, win 71.4%; test 1-day avg +0.079%, test 2-day avg -0.264%, test 5-day avg -0.883%.
- `Price_Above_SMA50 = 1` (5-day): train n=248, avg -0.294%, win 56.0%; validation n=75, avg -0.126%, win 56.0%; test n=26, avg -0.842%, win 69.2%; test 1-day avg -0.110%, test 2-day avg -0.271%, test 5-day avg -0.842%.
- `BuyCall_GEXDeltaPerc <= train_q40 (42.38) AND Price_Above_SMA50 = 1` (5-day): train n=111, avg -0.605%, win 63.1%; validation n=30, avg -0.274%, win 63.3%; test n=10, avg -0.954%, win 70.0%; test 1-day avg -0.067%, test 2-day avg -0.207%, test 5-day avg -0.954%.
...
- `GEX_ZScore_60day`: model weight +0.7526
- `GEX_Falling`: model weight +0.4305
- `SVix_DarkPoolIndex`: model weight -0.3093
- `GEX_Rising`: model weight -0.2717
- `GEX_Positive`: model weight +0.2582
- `Is_Swing_Up`: model weight +0.2483
- `Is_Potential_Swing_Down`: model weight -0.2364
- `GEXChange_Positive`: model weight +0.2349
- `Is_Swing_Down`: model weight +0.2226
- `Price_Above_SMA50`: model weight -0.2222
- `Pot_Swing_Up_AND_Neg_GEXChange`: model weight +0.2171
- `GEX_Percentile_VeryHigh`: model weight -0.2049

### Rejected Or Downgraded Patterns

- `BB_Bandwidth <= train_q10 (0.04043) AND GEX_Trending_Up = 1` (5-day): train n=24, avg +0.997%, win 75.0%; validation n=39, avg +1.016%, win 84.6%; test n=41, avg -0.174%, win 43.9%; test 1-day avg -0.044%, test 2-day avg -0.080%, test 5-day avg -0.174%.
- `BuyCall_GEXDeltaPerc <= train_q10 (28.08)` (5-day): train n=58, avg -0.807%, win 69.0%; validation n=12, avg -0.399%, win 75.0%; test n=5, avg +0.038%, win 40.0%; test 1-day avg +0.158%, test 2-day avg +0.244%, test 5-day avg +0.038%.
- `BB_PercentB >= train_q90 (0.8979)` (5-day): train n=58, avg -0.633%, win 56.9%; validation n=24, avg -0.093%, win 41.7%; test n=6, avg +0.038%, win 33.3%; test 1-day avg -0.132%, test 2-day avg -0.243%, test 5-day avg +0.038%.
- `BB_Bandwidth <= train_q10 (0.04043) AND GEXChange >= train_q50 (-5.1)` (5-day): train n=22, avg +0.596%, win 68.2%; validation n=30, avg +0.517%, win 70.0%; test n=39, avg -0.537%, win 30.8%; test 1-day avg -0.163%, test 2-day avg -0.385%, test 5-day avg -0.537%.
- `GEX_Turned_Positive = 1 AND GEX_Trending_Up = 0` (5-day): train n=22, avg -0.589%, win 63.6%; validation n=5, avg -0.264%, win 60.0%; test n=9, avg +0.209%, win 44.4%; test 1-day avg -0.408%, test 2-day avg +0.217%, test 5-day avg +0.209%.
- `GEX_Turned_Positive = 1` (5-day): train n=27, avg -0.561%, win 63.0%; validation n=5, avg -0.264%, win 60.0%; test n=10, avg +0.221%, win 40.0%; test 1-day avg -0.323%, test 2-day avg +0.266%, test 5-day avg +0.221%.
...
#### GEX_Trending_Up = 0 AND Price_Above_SMA50 = 1
- **Tier:** Tier 1
- **Signal:** Bearish/Risk-Off for the next 5 trading days.
- **Historical Evidence:** `GEX_Trending_Up = 0 AND Price_Above_SMA50 = 1` (5-day): train n=164, avg -0.370%, win 57.3%; validation n=31, avg -0.405%, win 67.7%; test n=8, avg -1.805%, win 100.0%; test 1-day avg -0.316%, test 2-day avg -0.801%, test 5-day avg -1.805%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for TLT. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** High; downgrade if current option flow strongly contradicts it.

#### BuyCall_GEXDeltaPerc <= train_q40 (42.38) AND GEX_Trending_Up = 0
- **Tier:** Tier 1
- **Signal:** Bearish/Risk-Off for the next 5 trading days.
- **Historical Evidence:** `BuyCall_GEXDeltaPerc <= train_q40 (42.38) AND GEX_Trending_Up = 0` (5-day): train n=162, avg -0.455%, win 60.5%; validation n=17, avg -0.448%, win 64.7%; test n=14, avg -1.036%, win 85.7%; test 1-day avg -0.127%, test 2-day avg -0.239%, test 5-day avg -1.036%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for TLT. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** High; downgrade if current option flow strongly contradicts it.

#### BuyCall_GEXDeltaPerc <= train_q30 (38.37) AND GEX_Trending_Up = 0
- **Tier:** Tier 2
- **Signal:** Bearish/Risk-Off for the next 5 trading days.
- **Historical Evidence:** `BuyCall_GEXDeltaPerc <= train_q30 (38.37) AND GEX_Trending_Up = 0` (5-day): train n=122, avg -0.704%, win 65.6%; validation n=13, avg -0.520%, win 69.2%; test n=10, avg -0.841%, win 80.0%; test 1-day avg -0.146%, test 2-day avg -0.364%, test 5-day avg -0.841%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for TLT. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** Medium; downgrade if current option flow strongly contradicts it.

#### BuyCall_GEXDeltaPerc <= train_q30 (38.37) AND Price_Above_SMA50 = 1
- **Tier:** Tier 2
- **Signal:** Bearish/Risk-Off for the next 5 trading days.
- **Historical Evidence:** `BuyCall_GEXDeltaPerc <= train_q30 (38.37) AND Price_Above_SMA50 = 1` (5-day): train n=89, avg -0.806%, win 65.2%; validation n=22, avg -0.399%, win 72.7%; test n=7, avg -0.883%, win 71.4%; test 1-day avg +0.079%, test 2-day avg -0.264%, test 5-day avg -0.883%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for TLT. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** Medium; downgrade if current option flow strongly contradicts it.
...
- **Historical Test Win Rate When Covered:** 42.4%
