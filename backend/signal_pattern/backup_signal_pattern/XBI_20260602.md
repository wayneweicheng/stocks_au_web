...
This prompt was generated for `XBI.US` with requested as-of date `2026-05-26` from a fresh SQL Server extraction for this ticker. Candidate rules and the feature-score gate were evaluated separately on `TomorrowChange`, `Next2DaysChange`, and `Next5DaysChange`. The selected primary target for this ticker is `Next5DaysChange` (next 5 trading days). This section is research metadata only; do not use it as today's market state during live or historical replay analysis.
...
- Daily feature rows: 630 total, 613 selected-target labeled rows from 2023-09-25 to 2026-05-15.
- Train split: 2023-09-25 to 2025-08-07, 429 rows.
- Validation split: 2025-08-08 to 2025-12-26, 92 rows.
- Test split: 2025-12-29 to 2026-05-15, 92 rows.
...
- 5-day: feature-score test win 66.0%, coverage 47/92 (51.1%), selection rank value 665.79, accepted robust patterns 6.
- 2-day: feature-score test win 47.2%, coverage 36/93 (38.7%), selection rank value 476.44, accepted robust patterns 6.
- 1-day: feature-score test win 43.5%, coverage 23/93 (24.7%), selection rank value 437.10, accepted robust patterns 6.
- Baseline selected-target win rate: train 49.4%, validation 75.0%, test 53.3%.
- Baseline tomorrow win rate: train 52.7%, validation 62.4%, test 47.3%.
- Baseline 2-day win rate: train 49.2%, validation 62.0%, test 48.4%.
- Baseline 5-day win rate: train 49.4%, validation 75.0%, test 53.3%.
- Selective feature-score gate: threshold 0.50 on the trained probability score.
- Feature-score train performance on selected target: win 68.9%, coverage 212/429 (49.4%), avg selected return +1.457%.
- Feature-score validation performance on selected target: win 78.6%, coverage 28/92 (30.4%), avg selected return +2.491%.
- Feature-score test performance on selected target: win 66.0%, coverage 47/92 (51.1%), avg selected return +1.104%.
- Large option trade rows sampled: 347.
- Latest OI-change records sampled: 6. Positive call OI change 1117; positive put OI change 2742; near-term call additions 301; near-term put additions 1556.
- Top current OI records sampled: 50.
- 30-minute bars sampled: 154.
- Broad feature audit rules tested: 298 single-feature rules and 33 two-feature combinations.

### Accepted Patterns

- `SVix_DarkPoolBuyRatio <= train_q30 (0.62)` (5-day): train n=123, avg +0.950%, win 56.9%; validation n=22, avg +1.549%, win 72.7%; test n=14, avg +1.604%, win 85.7%; test 1-day avg +0.116%, test 2-day avg +0.441%, test 5-day avg +1.604%.
- `SVix_DarkPoolIndex <= train_q30 (38.1)` (5-day): train n=121, avg +0.934%, win 56.2%; validation n=19, avg +1.029%, win 68.4%; test n=14, avg +1.604%, win 85.7%; test 1-day avg +0.116%, test 2-day avg +0.441%, test 5-day avg +1.604%.
- `SVix_DarkPoolBuyRatio <= train_q30 (0.62) AND SVix_DarkPoolIndex <= train_q30 (38.1)` (5-day): train n=121, avg +0.934%, win 56.2%; validation n=19, avg +1.029%, win 68.4%; test n=14, avg +1.604%, win 85.7%; test 1-day avg +0.116%, test 2-day avg +0.441%, test 5-day avg +1.604%.
- `BuyPut_GEXDeltaPerc >= train_q60 (52.41) AND SVix_DarkPoolBuyRatio <= train_q30 (0.62)` (5-day): train n=44, avg +1.932%, win 61.4%; validation n=14, avg +0.575%, win 64.3%; test n=6, avg +1.430%, win 83.3%; test 1-day avg +0.517%, test 2-day avg +0.768%, test 5-day avg +1.430%.
- `TodayChange <= train_q20 (-1.404)` (5-day): train n=86, avg +0.957%, win 62.8%; validation n=9, avg +3.108%, win 100.0%; test n=20, avg +1.800%, win 65.0%; test 1-day avg +0.395%, test 2-day avg +1.122%, test 5-day avg +1.800%.
- `TodayChange <= train_q30 (-0.882) AND GEX_ZScore <= train_q10 (-0.7009)` (5-day): train n=20, avg +0.980%, win 65.0%; validation n=6, avg +4.255%, win 100.0%; test n=13, avg +2.287%, win 61.5%; test 1-day avg +0.434%, test 2-day avg +1.389%, test 5-day avg +2.287%.
...
The model is intentionally selective. Historical test coverage was 47/92 (51.1%), which means many days did not qualify for a high-confidence forecast. In the live report, you must clearly label whether today's setup is inside or outside the validated high-confidence regime.
...
- `MACD_Positive`: model weight +0.5088
- `MACD_Line`: model weight -0.5077
- `SVix_DarkPoolIndex`: model weight -0.4783
- `GEX_Trending_Up`: model weight -0.3640
- `GEX_DayChange`: model weight +0.3446
- `BB_Breakout_Upper`: model weight -0.3326
- `GEX_BigDrop`: model weight +0.3263
- `GEX_HighVolatility`: model weight +0.3142
- `SMA20_Above_SMA50`: model weight +0.2987
- `Setup_Volatility_Crush`: model weight +0.2745
- `GEX_Volatility`: model weight -0.2670
- `Is_Potential_Swing_Down`: model weight -0.2489

### Rejected Or Downgraded Patterns

- `VIX >= train_q70 (18.21) AND BuyPut_GEXDeltaPerc >= train_q60 (52.41)` (5-day): train n=24, avg +1.692%, win 70.8%; validation n=12, avg +3.539%, win 91.7%; test n=21, avg -0.336%, win 38.1%; test 1-day avg -0.198%, test 2-day avg -0.549%, test 5-day avg -0.336%.
- `TodayChange <= train_q20 (-1.404) AND BuyPut_GEXDeltaPerc >= train_q60 (52.41)` (5-day): train n=39, avg +1.483%, win 69.2%; validation n=6, avg +2.998%, win 100.0%; test n=7, avg -0.441%, win 28.6%; test 1-day avg -0.409%, test 2-day avg -0.090%, test 5-day avg -0.441%.
- `TodayChange <= train_q30 (-0.882) AND BuyPut_GEXDeltaPerc >= train_q60 (52.41)` (5-day): train n=51, avg +1.376%, win 66.7%; validation n=9, avg +2.099%, win 88.9%; test n=9, avg -0.886%, win 22.2%; test 1-day avg -0.398%, test 2-day avg -0.356%, test 5-day avg -0.886%.
- `BuyPut_GEXDeltaPerc >= train_q60 (52.41) AND BuyCall_GEXDeltaPerc <= train_q20 (13.96)` (5-day): train n=47, avg +1.361%, win 66.0%; validation n=23, avg +1.014%, win 60.9%; test n=9, avg -0.174%, win 44.4%; test 1-day avg -0.252%, test 2-day avg -0.753%, test 5-day avg -0.174%.
- `VIX >= train_q70 (18.21) AND GEX_PctChange <= train_q10 (-70.55)` (5-day): train n=24, avg +1.298%, win 62.5%; validation n=7, avg +3.879%, win 85.7%; test n=14, avg -0.188%, win 42.9%; test 1-day avg -0.446%, test 2-day avg +0.105%, test 5-day avg -0.188%.
- `GEX_ZScore >= train_q90 (0.9171)` (5-day): train n=43, avg -1.083%, win 48.8%; validation n=14, avg +0.313%, win 42.9%; test n=24, avg +0.879%, win 41.7%; test 1-day avg -0.073%, test 2-day avg +0.051%, test 5-day avg +0.879%.
...
- **Historical Evidence:** `SVix_DarkPoolBuyRatio <= train_q30 (0.62)` (5-day): train n=123, avg +0.950%, win 56.9%; validation n=22, avg +1.549%, win 72.7%; test n=14, avg +1.604%, win 85.7%; test 1-day avg +0.116%, test 2-day avg +0.441%, test 5-day avg +1.604%.
...
- **Tier:** Tier 1
- **Signal:** Bullish for the next 5 trading days.
- **Historical Evidence:** `SVix_DarkPoolIndex <= train_q30 (38.1)` (5-day): train n=121, avg +0.934%, win 56.2%; validation n=19, avg +1.029%, win 68.4%; test n=14, avg +1.604%, win 85.7%; test 1-day avg +0.116%, test 2-day avg +0.441%, test 5-day avg +1.604%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for XBI. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** High; downgrade if current option flow strongly contradicts it.
...
- **Tier:** Tier 2
- **Signal:** Bullish for the next 5 trading days.
- **Historical Evidence:** `SVix_DarkPoolBuyRatio <= train_q30 (0.62) AND SVix_DarkPoolIndex <= train_q30 (38.1)` (5-day): train n=121, avg +0.934%, win 56.2%; validation n=19, avg +1.029%, win 68.4%; test n=14, avg +1.604%, win 85.7%; test 1-day avg +0.116%, test 2-day avg +0.441%, test 5-day avg +1.604%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for XBI. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** Medium; downgrade if current option flow strongly contradicts it.

#### BuyPut_GEXDeltaPerc >= train_q60 (52.41) AND SVix_DarkPoolBuyRatio <= train_q30 (0.62)
- **Tier:** Tier 2
- **Signal:** Bullish for the next 5 trading days.
- **Historical Evidence:** `BuyPut_GEXDeltaPerc >= train_q60 (52.41) AND SVix_DarkPoolBuyRatio <= train_q30 (0.62)` (5-day): train n=44, avg +1.932%, win 61.4%; validation n=14, avg +0.575%, win 64.3%; test n=6, avg +1.430%, win 83.3%; test 1-day avg +0.517%, test 2-day avg +0.768%, test 5-day avg +1.430%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for XBI. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** Medium; downgrade if current option flow strongly contradicts it.
...
- **Historical Test Coverage:** 47/92 (51.1%)
