...
- Broad feature audit rules tested: 302 single-feature rules and 2001 two-feature combinations.

### Accepted Patterns

- `Prev2DaysChange <= train_q50 (0.215) AND GEX_DayChange <= train_q10 (-5.69e+04)` (5-day): train n=22, avg +0.057%, win 45.5%; validation n=5, avg +0.562%, win 80.0%; test n=9, avg +1.341%, win 100.0%; test tomorrow avg -0.281%, test 2-day avg -0.017%.
...
- `BB_Bandwidth >= train_q70 (0.06827) AND Is_Swing_Down = 0` (5-day): train n=148, avg +0.973%, win 68.9%; validation n=17, avg +0.992%, win 82.4%; test n=23, avg +2.005%, win 82.6%; test tomorrow avg +0.611%, test 2-day avg +0.964%.
...
#### Prev2DaysChange <= train_q50 (0.215) AND GEX_DayChange <= train_q10 (-5.69e+04)
- **Tier:** Tier 1
- **Signal:** Bullish for the next 5 trading days.
- **Historical Evidence:** `Prev2DaysChange <= train_q50 (0.215) AND GEX_DayChange <= train_q10 (-5.69e+04)` (5-day): train n=22, avg +0.057%, win 45.5%; validation n=5, avg +0.562%, win 80.0%; test n=9, avg +1.341%, win 100.0%; test tomorrow avg -0.281%, test 2-day avg -0.017%.
...
#### BB_Bandwidth >= train_q60 (0.0599) AND BuyCall_GEXDeltaPerc <= train_q40 (43.47)
- **Tier:** Tier 2
- **Signal:** Bullish for the next 5 trading days.
- **Historical Evidence:** `BB_Bandwidth >= train_q60 (0.0599) AND BuyCall_GEXDeltaPerc <= train_q40 (43.47)` (5-day): train n=83, avg +1.044%, win 74.7%; validation n=13, avg +1.160%, win 92.3%; test n=10, avg +1.978%, win 90.0%; test tomorrow avg +0.252%, test 2-day avg +0.686%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for SPXW. Use tomorrow behavior as timing risk and 2-day behavior as early confirmation.
- **Priority:** Medium; downgrade if current option flow strongly contradicts it.
