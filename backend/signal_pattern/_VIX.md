# Quantitative Trading Analysis: _VIX
...
**Task:** Analyze the provided _VIX market data to forecast price action over the next 5 trading days. The 1-day, 2-day, and 5-day horizons were all researched during prompt generation; the signal strength classification must be based primarily on the selected horizon because it had the strongest held-out support for this ticker.
...
This prompt was generated for `_VIX.US` with requested as-of date `2026-05-22` from a fresh SQL Server extraction for this ticker. Candidate rules and the feature-score gate were evaluated separately on `TomorrowChange`, `Next2DaysChange`, and `Next5DaysChange`. The selected primary target for this ticker is `Next5DaysChange` (next 5 trading days). This section is research metadata only; do not use it as today's market state during live or historical replay analysis.
...
- Daily feature rows: 627 total, 622 selected-target labeled rows from 2023-09-29 to 2026-05-14.
- Train split: 2023-09-29 to 2025-08-08, 435 rows.
- Validation split: 2025-08-11 to 2025-12-22, 93 rows.
- Test split: 2025-12-23 to 2026-05-14, 94 rows.
- Selected target: `Next5DaysChange` (next 5 trading days).
- Target selection summary:
- 5-day: target-selection score 139.29; feature-score test win 66.7%, coverage 21/94 (22.3%), accepted robust patterns 6.
- 2-day: target-selection score 91.48; feature-score test win 61.5%, coverage 13/94 (13.8%), accepted robust patterns 6.
- 1-day: target-selection score 80.59; feature-score test win 50.0%, coverage 26/94 (27.7%), accepted robust patterns 6.
- Baseline selected-target win rate: train 44.8%, validation 50.5%, test 57.4%.
- Baseline tomorrow win rate: train 42.2%, validation 47.9%, test 47.9%.
- Baseline 2-day win rate: train 46.2%, validation 56.4%, test 53.2%.
- Baseline 5-day win rate: train 44.8%, validation 50.5%, test 57.4%.
- Selective feature-score gate: threshold 0.60 on the trained probability score.
- Feature-score train performance on selected target: win 78.2%, coverage 124/435 (28.5%), avg selected return +9.242%.
- Feature-score validation performance on selected target: win 69.8%, coverage 43/93 (46.2%), avg selected return +8.049%.
- Feature-score test performance on selected target: win 66.7%, coverage 21/94 (22.3%), avg selected return +7.698%.
- Large option trade rows sampled: 0.
- Latest OI-change records sampled: 87. Positive call OI change 185464; positive put OI change 59423; near-term call additions 8959; near-term put additions 0.
- Top current OI records sampled: 50.
- 30-minute bars sampled: 0.
- Broad feature audit rules tested: 278 single-feature rules and 235 two-feature combinations.

### Accepted Patterns

- `VIX <= train_q40 (15.17)` (5-day): train n=174, avg +4.327%, win 58.0%; validation n=17, avg +5.743%, win 82.4%; test n=11, avg +7.485%, win 90.9%; test 1-day avg +1.808%, test 2-day avg +4.075%, test 5-day avg +7.485%.
- `VIX <= train_q50 (16.02)` (5-day): train n=218, avg +4.490%, win 56.0%; validation n=33, avg +3.388%, win 66.7%; test n=17, avg +7.506%, win 88.2%; test 1-day avg +2.398%, test 2-day avg +4.993%, test 5-day avg +7.506%.
- `Prev10DaysChange >= train_q90 (22.05) AND VIX >= train_q70 (18.14)` (5-day): train n=36, avg -13.691%, win 86.1%; validation n=7, avg -24.904%, win 100.0%; test n=9, avg -6.118%, win 77.8%; test 1-day avg -6.094%, test 2-day avg -7.992%, test 5-day avg -6.118%.
- `Prev10DaysChange >= train_q90 (22.05) AND VIX >= train_q80 (19.59)` (5-day): train n=30, avg -14.407%, win 86.7%; validation n=6, avg -28.355%, win 100.0%; test n=9, avg -6.118%, win 77.8%; test 1-day avg -6.094%, test 2-day avg -7.992%, test 5-day avg -6.118%.
- `VIX_Very_High = 1 AND Prev10DaysChange >= train_q90 (22.05)` (5-day): train n=28, avg -15.609%, win 89.3%; validation n=6, avg -28.355%, win 100.0%; test n=9, avg -6.118%, win 77.8%; test 1-day avg -6.094%, test 2-day avg -7.992%, test 5-day avg -6.118%.
- `Prev10DaysChange >= train_q90 (22.05) AND VIX >= train_q90 (22.16)` (5-day): train n=21, avg -18.910%, win 90.5%; validation n=5, avg -29.782%, win 100.0%; test n=5, avg -5.318%, win 80.0%; test 1-day avg -4.760%, test 2-day avg -7.062%, test 5-day avg -5.318%.
...
The model is intentionally selective. Historical test coverage was 21/94 (22.3%), which means many days did not qualify for a high-confidence forecast. In the live report, you must clearly label whether today's setup is inside or outside the validated high-confidence regime.
...
- `VIX`: model weight -1.0081
- `GEX_Trending_Up`: model weight -0.4772
- `SVix_DarkPoolIndex`: model weight +0.4094
- `GEX_Percentile_VeryHigh`: model weight -0.3389
- `VIX_Very_High`: model weight -0.3210
- `RSI`: model weight +0.2980
- `GEX_BigDrop`: model weight -0.2757
- `Price_Above_SMA20`: model weight -0.2651
- `GEX_Positive`: model weight +0.2630
- `GEX_ZScore_High`: model weight -0.2628
- `GEX_Above_SMA10`: model weight +0.2541
- `GEX_Rising`: model weight +0.2486

### Rejected Or Downgraded Patterns

- `Price_Above_SMA20 = 1 AND VIX >= train_q80 (19.59)` (5-day): train n=31, avg -18.496%, win 90.3%; validation n=5, avg -25.114%, win 100.0%; test n=29, avg +0.693%, win 55.2%; test 1-day avg -0.612%, test 2-day avg +0.116%, test 5-day avg +0.693%.
- `BB_PercentB >= train_q50 (0.4536) AND VIX >= train_q80 (19.59)` (5-day): train n=31, avg -18.496%, win 90.3%; validation n=6, avg -17.903%, win 83.3%; test n=31, avg +0.380%, win 54.8%; test 1-day avg -0.774%, test 2-day avg -0.435%, test 5-day avg +0.380%.
- `Price_Above_SMA20 = 1 AND VIX >= train_q70 (18.14)` (5-day): train n=49, avg -11.924%, win 77.6%; validation n=5, avg -25.114%, win 100.0%; test n=33, avg +1.101%, win 54.5%; test 1-day avg -0.040%, test 2-day avg +0.229%, test 5-day avg +1.101%.
- `VIX >= train_q60 (16.87) AND TodayChange <= train_q10 (-7.684)` (5-day): train n=24, avg -11.865%, win 95.8%; validation n=7, avg -9.779%, win 85.7%; test n=9, avg +2.848%, win 44.4%; test 1-day avg -0.608%, test 2-day avg +4.781%, test 5-day avg +2.848%.
- `BB_PercentB >= train_q50 (0.4536) AND VIX >= train_q70 (18.14)` (5-day): train n=51, avg -11.630%, win 76.5%; validation n=6, avg -17.903%, win 83.3%; test n=36, avg +1.541%, win 52.8%; test 1-day avg -0.026%, test 2-day avg +0.161%, test 5-day avg +1.541%.
- `VIX >= train_q70 (18.14) AND TodayChange <= train_q20 (-4.75)` (5-day): train n=36, avg -11.344%, win 91.7%; validation n=6, avg -15.935%, win 100.0%; test n=11, avg +2.073%, win 45.5%; test 1-day avg +0.106%, test 2-day avg +3.669%, test 5-day avg +2.073%.
...
- **Historical Evidence:** `VIX <= train_q40 (15.17)` (5-day): train n=174, avg +4.327%, win 58.0%; validation n=17, avg +5.743%, win 82.4%; test n=11, avg +7.485%, win 90.9%; test 1-day avg +1.808%, test 2-day avg +4.075%, test 5-day avg +7.485%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for _VIX. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** High; downgrade if current option flow strongly contradicts it.

#### VIX <= train_q50 (16.02)
- **Tier:** Tier 1
- **Signal:** Bullish for the next 5 trading days.
- **Historical Evidence:** `VIX <= train_q50 (16.02)` (5-day): train n=218, avg +4.490%, win 56.0%; validation n=33, avg +3.388%, win 66.7%; test n=17, avg +7.506%, win 88.2%; test 1-day avg +2.398%, test 2-day avg +4.993%, test 5-day avg +7.506%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for _VIX. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** High; downgrade if current option flow strongly contradicts it.

#### Prev10DaysChange >= train_q90 (22.05) AND VIX >= train_q70 (18.14)
- **Tier:** Tier 2
- **Signal:** Bearish/Risk-Off for the next 5 trading days.
- **Historical Evidence:** `Prev10DaysChange >= train_q90 (22.05) AND VIX >= train_q70 (18.14)` (5-day): train n=36, avg -13.691%, win 86.1%; validation n=7, avg -24.904%, win 100.0%; test n=9, avg -6.118%, win 77.8%; test 1-day avg -6.094%, test 2-day avg -7.992%, test 5-day avg -6.118%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for _VIX. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** Medium; downgrade if current option flow strongly contradicts it.

#### Prev10DaysChange >= train_q90 (22.05) AND VIX >= train_q80 (19.59)
- **Tier:** Tier 2
- **Signal:** Bearish/Risk-Off for the next 5 trading days.
- **Historical Evidence:** `Prev10DaysChange >= train_q90 (22.05) AND VIX >= train_q80 (19.59)` (5-day): train n=30, avg -14.407%, win 86.7%; validation n=6, avg -28.355%, win 100.0%; test n=9, avg -6.118%, win 77.8%; test 1-day avg -6.094%, test 2-day avg -7.992%, test 5-day avg -6.118%.
- **Rationale:** Use this as an explainable stock-specific 5-day market-flow rule for _VIX. Cross-check the other horizons for timing, confirmation, or conflict.
- **Priority:** Medium; downgrade if current option flow strongly contradicts it.
...
- **Historical Test Coverage:** 21/94 (22.3%)
