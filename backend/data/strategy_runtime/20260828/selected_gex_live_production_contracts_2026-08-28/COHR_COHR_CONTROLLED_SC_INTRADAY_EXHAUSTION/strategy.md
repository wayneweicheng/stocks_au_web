# COHR — Controlled Sell-Call / Intraday Exhaustion — 1.0.0-production
...
`COHR_CONTROLLED_SC_INTRADAY_EXHAUSTION`
...
COHR multi-day bearish exhaustion when sell-call share is controlled and D0 has not already suffered an extreme whole-session or RTH decline.
...
Resolved research instances: **21**; wins **21**; win rate **100.0%**; average direction-adjusted return **11.52%**; profit factor **∞**.
