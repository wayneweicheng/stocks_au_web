# DIA — GEX Washout Reversal — 1.0.0-production
...
DIA mean-reversion setup after aggregate GEX falls more than one 20-observation standard deviation below its rolling mean.
...
Resolved research instances: **41**; wins **31**; win rate **75.6%**; average direction-adjusted return **0.92%**; profit factor **5.02**.
