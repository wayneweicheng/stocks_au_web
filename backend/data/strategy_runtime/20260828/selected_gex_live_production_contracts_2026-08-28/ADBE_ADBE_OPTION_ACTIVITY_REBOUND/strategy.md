# ADBE — Option Activity Rebound — 1.0.0-production
...
ADBE bullish D5 regime when bought-put contract breadth and total option participation are not unusually elevated.
...
Resolved research instances: **43**; wins **35**; win rate **81.4%**; average direction-adjusted return **4.07%**; profit factor **5.27**.
