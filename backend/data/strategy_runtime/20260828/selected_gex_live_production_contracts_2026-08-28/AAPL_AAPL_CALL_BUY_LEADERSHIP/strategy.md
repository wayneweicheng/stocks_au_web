# AAPL — Call-Buy Leadership — 1.0.0-production
...
AAPL bullish continuation when bought-call share is elevated relative to its own causal history and Nasdaq/QQQ closes D0 positively.
...
Resolved research instances: **43**; wins **35**; win rate **81.4%**; average direction-adjusted return **0.99%**; profit factor **4.46**.
