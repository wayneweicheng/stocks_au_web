...
def signal_notification(
    ...
    if classification == SignalClassification.STRONG_YELLOW:
        ...
        common[6:6] = [
            ...
            f"Dip Limit: {_money(plan.dip_price)}",
        ...
        notification_type = "SIGNAL_READY"
        common[6:6] = ["Entry Rule: BUY at D3 03:30 New York", "TP: +2.50%", "Otherwise: D5 cash close"]
