...
{
    public partial class BrokerAnalysis : System.Web.UI.Page
    {
        DataSet dsDataSet1;
        DataSet dsDataSet2;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                ddlBrokerCode.SelectedIndex = 0;
                brokerCode = "BelPot";
                int i = 0;
                foreach (ListItem item in ddlBrokerCode.Items)
                {
                    if (item.Value.ToLower() == brokerCode.ToLower())
                        ddlBrokerCode.SelectedIndex = i;
                    i++;
                }
                FilldsDataSet1();
                //FilldsDataSet2();
        ...
        public void GetDataSet1()
        {
            ...
            dsDataSet1 = doDataSet1.GetBrokerAnalysis(sortBy, Convert.ToInt16(txtNumPrevDay.Text), brokerCode);
        }
