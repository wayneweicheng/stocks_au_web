...
{
    public partial class FirstBuySell : System.Web.UI.Page
    {
        ...
        public void GetCourseOfSale(string pvchStockCode)
        {
            ...
            dsCourseOfSale = doCourseOfSale.GetFirstBuySell(pvchStockCode, numPrevDay);
        }
        public void GetStockListInfo()
        {
            DataOperation doStockListInfo = new DataOperation();
            dsStockListInfo = doStockListInfo.GetFirstBuySellStock();
        }
