<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrokerBuySellPerc.aspx.cs" Inherits="StockInfoReport.BrokerBuySellPerc" EnableEventValidation="false" Title="Broker Buy Sell Percentage"%>
...
<body>
    ...
    <div><a href="Default.aspx">Click to go to the main page</a><br /><br /></div>
        ...
        Order by: <asp:DropDownList ID ="ddlOrderBy" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOrderBy_SelectedIndexChanged">
            <asp:ListItem>Buy Perc Desc</asp:ListItem>
            <asp:ListItem>Sell Perc Desc</asp:ListItem>
        </asp:DropDownList>
        ...
        <asp:TextBox ID="txtObservationEndDate" runat="server" Width="134px" AutoPostBack="True" OnTextChanged="txtObservationEndDate_TextChanged"></asp:TextBox>
        &nbsp;&nbsp;&nbsp; Number of Previous Days:  &nbsp
        ...
        Stock Broker Data<br />
        <asp:GridView ID="gvDataSet1" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" OnPageIndexChanging="gvDataSet1_PageIndexChanging" OnRowDataBound="gvDataSet1_RowDataBound" OnRowCreated="gvDataSe1_RowCreated" PageSize="100" Font-Size="Smaller" PagerSettings-PageButtonCount="20">
