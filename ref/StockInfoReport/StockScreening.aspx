<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockScreening.aspx.cs" Inherits="StockInfoReport.StockScreening" EnableEventValidation="false" Title="Stock Screening"%>
...
<body>
    ...
    <div><a href="Default.aspx">Click to go to the main page</a><br /><br /></div>
        ...
        Order by: <asp:DropDownList ID ="ddlOrderBy" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOrderBy_SelectedIndexChanged">
            ...
            <asp:ListItem>Director Market Buy</asp:ListItem>
            
        </asp:DropDownList>
        <br />
        <br />
        Stock Screening<br />
        <asp:GridView ID="gvDataSet1" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" OnPageIndexChanging="gvDataSet1_PageIndexChanging" OnRowDataBound="gvDataSet1_RowDataBound" OnRowCreated="gvDataSe1_RowCreated" PageSize="100" Font-Size="X-Small" PagerSettings-PageButtonCount="20" OnRowCommand="gvDataSet1_RowCommand" BorderStyle="Solid" BorderWidth="1px">
