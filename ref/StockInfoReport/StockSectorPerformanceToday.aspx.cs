...
{
    public partial class StockSectorPerformanceToday : System.Web.UI.Page
    {
        DataSet dsDataSet1;
        DataSet dsDataSet2;
        string sortBy;
        ...
        public void GetDataSet1()
        {
            ...
            dsDataSet1 = doDataSet1.GetStockSectorPerformance(sortBy, Convert.ToInt16(txtNumPrevDay.Text));
        }
