...
<body>
    ...
    <div>
        <table style="width: 900px; cellspacing="15" cellpadding="5">
            ...
            <tr style="height: 30px">
                <td>
                    <a href="CourseOfSaleInstitute.aspx?StockCode=TSLA.US&ObservationDate=2050-12-12&NumPrevDay=0&CustomFilterID=0&BrokerCodeIndex=0">To view the course of sale Institute on stocks</a>
                </td>
                <td>
                    <a href="CourseOfSale.aspx?StockCode=TSLA.US&ObservationDate=2050-12-12&NumPrevDay=0&CustomFilterID=0&BrokerCodeIndex=0">To view the course of sale on stocks</a>
                </td>
            </tr>
            <tr style="height: 30px">
                <td>
            ...
            <tr style="height: 30px">
                <td>
                    <a href="TradeStrategySuggestion.aspx?ReportType=0&NumPrevDay=1">To view Trade Strategy Suggestions</a>
                </td>
                <td>
