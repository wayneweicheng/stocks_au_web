...
{
    public partial class StockAnnouncementToday : System.Web.UI.Page
    {
        DataSet dsDataSet1;
        DataSet dsDataSet2;
        string sortBy;
        ...
        public void GetDataSet1()
        {
            ...
            dsDataSet1 = doDataSet1.GetStockAnnouncement(sortBy, Convert.ToInt16(txtNumPrevDay.Text));
        }
        ...
        protected void gvDataSet1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (drv != null)
                {
                    ...
                    string[] annKeyWords = new string[] { "ACQUISITION", "OFF TAKE", "OFF-TAKE", "OFF TAKE", "partnership agreement"};
