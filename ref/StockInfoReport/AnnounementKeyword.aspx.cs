...
{
    public partial class AnnounementKeyword : System.Web.UI.Page
    {
        DataSet dsDataSet1;
        DataSet dsDataSet2;
        string searchToken;
        ...
        public void FilldsDataSet1(string searchToken)
        {
            GetDataSet1(searchToken);
            gvDataSet1.DataSource = dsDataSet1.Tables[0];
            gvDataSet1.DataBind();
        }

        public void FilldsDataSet2(string searchToken)
        {
            //GetDataSet2(searchToken);
            //gvDataSet2.DataSource = dsDataSet2.Tables[0];
            //gvDataSet2.DataBind();
        }

        public void GetDataSet1(string searchToken)
        {
            DataOperation doDataSet1 = new DataOperation();
            dsDataSet1 = doDataSet1.CheckAnnouncementKeyword(searchToken);
        }

        public void GetDataSet2(string searchToken)
        {
            //DataOperation doDataSet2 = new DataOperation();
            //dsDataSet2 = doDataSet2.DirectorandMajorShareholder(searchToken);
        }

        protected void gvDataSet1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            searchToken = txtsearchToken.Text;
            FilldsDataSet1(searchToken);
        ...
        protected void btnsearchToken_Click(object sender, EventArgs e)
        {
            searchToken = txtsearchToken.Text;
            FilldsDataSet1(searchToken);
            FilldsDataSet2(searchToken);
