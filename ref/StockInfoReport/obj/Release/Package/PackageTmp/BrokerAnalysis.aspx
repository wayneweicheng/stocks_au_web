<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrokerAnalysis.aspx.cs" Inherits="StockInfoReport.BrokerAnalysis" EnableEventValidation="false" Title="Broker Analysis"%>
...
<body>
    ...
    <div><a href="Default.aspx">Click to go to the main page</a><br /><br /></div>
        ...
        Order by: <asp:DropDownList ID ="ddlOrderBy" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOrderBy_SelectedIndexChanged">
            <asp:ListItem>NetValuevsMC</asp:ListItem>
            <asp:ListItem>NetVolumevsTradeVolume</asp:ListItem>
            <asp:ListItem>MarketCap</asp:ListItem>
            <asp:ListItem>NetValue</asp:ListItem>
