<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ASX300StockSectorPerformance.aspx.cs" Inherits="StockInfoReport.ASX300StockSectorPerformance" EnableEventValidation="false" Title="ASX300 Stock Sector Performance"%>
...
<body>
    ...
    <div><a href="Default.aspx">Click to go to the main page</a><br /><br /></div>
        ...
        Order by: <asp:DropDownList ID ="ddlOrderBy" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOrderBy_SelectedIndexChanged">
            ...
            <asp:ListItem>Sector - AggregateNumDays</asp:ListItem> 
        </asp:DropDownList>
        ...
        Stock Screening<br />
        <asp:GridView ID="gvDataSet1" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" OnPageIndexChanging="gvDataSet1_PageIndexChanging" OnRowDataBound="gvDataSet1_RowDataBound" OnRowCreated="gvDataSe1_RowCreated" PageSize="200" Font-Size="X-Small" PagerSettings-PageButtonCount="20" OnRowCommand="gvDataSet1_RowCommand">
