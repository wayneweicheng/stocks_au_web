      ...
      <div className="min-h-screen text-slate-800">
        <div className="mx-auto max-w-7xl px-6 py-10">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/users/new" className="rounded-md bg-blue-600 text-white px-3 py-2 text-sm hover:bg-blue-700">
              + Add New User
            </Link>
          </div>
              ...
              <tbody>
                {data.items.map((u, idx) => (
                  <tr key={u.user_id} className={idx % 2 ? "bg-slate-50" : ""}>
                    ...
                    <td className="px-3 py-2">
                      <div className="flex gap-2">
                        <Link className="text-blue-600 hover:underline" href={`/users/${u.user_id}`}>View</Link>
                        <Link className="text-blue-600 hover:underline" href={`/users/${u.user_id}/edit`}>Edit</Link>
                        <Link className="text-blue-600 hover:underline" href={`/users/${u.user_id}/subscriptions`}>Subscriptions</Link>
