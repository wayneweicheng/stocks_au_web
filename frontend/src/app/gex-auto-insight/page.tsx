...
export default function GEXAutoInsightPage() {
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mb-6 p-4 rounded-lg border border-slate-200 bg-white">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-lg font-medium">Scheduler Status</h2>
            <button
              onClick={refreshAll}
              disabled={loading}
        ...
        <div className="mb-6 p-4 rounded-lg border border-slate-200 bg-white">
          <h2 className="text-lg font-medium mb-4">Stock Configuration</h2>
                      ...
                      {editingCode === stock.StockCode ? (
                        ...
                        <>
                          ...
                          <td className="px-3 py-2 text-center text-slate-500 text-xs">
                            {stock.LLMModel || "default"}
                          </td>
                          <td className="px-3 py-2 text-center">
                            <button
                              onClick={() => startEdit(stock)}
                              className="mr-2 text-xs text-slate-600 hover:text-slate-800"
                            >
                              Edit
                            </button>
                            <button
                              onClick={() => deleteStock(stock.StockCode)}
