        ...
        <div className="mx-auto max-w-5xl px-6 py-10">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-3">
              ...
              <Link href={`/notification-subscriptions/${userId}/edit`} className="text-blue-600 hover:underline">Edit</Link>
              <Link href={`/notification-subscriptions/${userId}/subscriptions`} className="text-blue-600 hover:underline">View Subscriptions</Link>
            </div>
          </div>
          {error && (
          ...
          {!user ? (
            ...
            <div className="grid gap-4">
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                ...
                <div className="mt-3">
                  <Link href={`/notification-subscriptions/${userId}/subscriptions`} className="rounded-md bg-blue-600 text-white px-3 py-2 text-sm">Manage Subscriptions</Link>
                </div>
              </div>
            </div>
          )}
