      ...
      <div className="min-h-screen text-slate-800">
        <div className="mx-auto max-w-7xl px-6 py-10">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href={`/notification-subscriptions/${userId}/subscriptions/new`} className="rounded-md bg-blue-600 text-white px-3 py-2 text-sm hover:bg-blue-700">
              + Add Subscription
            </Link>
          </div>
                    ...
                    <tr key={r.SubscriptionID} className={idx % 2 ? "bg-slate-50" : ""}>
                      ...
                      <td className="px-3 py-2">
                        <div className="flex gap-2">
                          <Link className="text-blue-600 hover:underline" href={`/notification-subscriptions/${userId}/subscriptions/${r.SubscriptionID}/edit`}>Edit</Link>
