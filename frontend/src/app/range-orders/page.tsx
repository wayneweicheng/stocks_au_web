...
export default function RangeOrdersPage() {
  ...
  const onPlaceOrders = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(typeof data?.detail === "string" ? data.detail : "Order placement failed");
      }
      setPlaceResult(data);
    } catch (e: any) {
            ...
            {submitted && generated && generated.length > 0 && (
              <div className="p-6 flex flex-col gap-3">
                ...
                <button
                  ...
                  className="self-start rounded-md bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-400/40 disabled:opacity-50 disabled:cursor-not-allowed"
                >
