    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        <section className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6">
            <h3 className="font-medium text-lg mb-1">Notification Subscriptions</h3>
            <p className="text-sm text-slate-600 mb-4">Manage notification users and their alert subscriptions.</p>
            <Link href="/notification-subscriptions" className="inline-block rounded-md bg-gradient-to-r from-emerald-600 to-green-600 text-white px-4 py-2 text-sm hover:opacity-90">Open page</Link>
          </div>
        </section>
      </div>
    </div>
