      ...
      <div className="relative">
        ...
        <div className={`absolute top-full left-0 mt-2 w-64 bg-white border border-slate-200 rounded-md shadow-lg transition-all duration-200 z-50 ${open ? "opacity-100 visible" : "opacity-0 invisible"}`}>
          <div className="py-2" role="menu">
            ...
            <Link onClick={() => setOpen(false)} href="/notification-subscriptions" className="block px-4 py-2 text-slate-700 hover:bg-emerald-50 hover:text-slate-900">Notification Subscriptions</Link>
            ...
            <Link onClick={() => setOpen(false)} href="/trading-signal-reports" className="block px-4 py-2 text-slate-700 hover:bg-emerald-50 hover:text-slate-900">Trading Signal Reports</Link>
