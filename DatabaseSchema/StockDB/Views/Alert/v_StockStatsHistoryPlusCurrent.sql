-- View: [Alert].[v_StockStatsHistoryPlusCurrent]


create view [Alert].[v_StockStatsHistoryPlusCurrent]
as
select *
from
(
	SELECT [ASXCode]
		  ...
		  ,row_number() over (partition by ASXCode order by CreateDate desc) as RowNumber
