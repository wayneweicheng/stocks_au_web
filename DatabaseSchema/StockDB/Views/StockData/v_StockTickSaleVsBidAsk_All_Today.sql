-- View: [StockData].[v_StockTickSaleVsBidAsk_All_Today]
...
create view [StockData].[v_StockTickSaleVsBidAsk_All_Today]
as
select 
...
(
	select 
		...
		b.DateFrom,
		b.DateTo
	from StockData.v_CourseOfSaleSecondary_By_Min as a
	inner join [StockData].[v_StockBidAsk] as b
	...
	select 
		...
		b.DateFrom,
		b.DateTo
	from [StockData].[v_StockBidAsk] as b
	left join StockData.v_CourseOfSaleSecondary_By_Min as a
	on a.SaleDateTime > b.DateFrom and a.SaleDateTime <= b.DateTo
	and a.ASXCode = b.ASXCode
	and a.ObservationDate = b.ObservationDate
