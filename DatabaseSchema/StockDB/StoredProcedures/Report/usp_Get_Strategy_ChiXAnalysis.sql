-- Stored procedure: [Report].[usp_Get_Strategy_ChiXAnalysis]


CREATE PROCEDURE [Report].[usp_Get_Strategy_ChiXAnalysis]
@pbitDebug AS BIT = 0,
...
AS
/******************************************************************************
File: usp_Get_Strategy_ChiXAnalysis.sql
Stored Procedure Name: usp_Get_Strategy_ChiXAnalysis
Overview
-----------------
usp_Get_Strategy_ChiXAnalysis
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_Get_Strategy_ChiXAnalysis'
		...
		inner join #TempChixAnalysis as d
