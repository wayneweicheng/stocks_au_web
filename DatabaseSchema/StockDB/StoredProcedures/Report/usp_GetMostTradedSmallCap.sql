-- Stored procedure: [Report].[usp_GetMostTradedSmallCap]



CREATE PROCEDURE [Report].[usp_GetMostTradedSmallCap]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_GetMostTradedSmallCap'
