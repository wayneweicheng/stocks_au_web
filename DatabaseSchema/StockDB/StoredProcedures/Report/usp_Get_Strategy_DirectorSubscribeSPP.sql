-- Stored procedure: [Report].[usp_Get_Strategy_DirectorSubscribeSPP]



CREATE PROCEDURE [Report].[usp_Get_Strategy_DirectorSubscribeSPP]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT,
@pbitASXCodeOnly as bit = 0
AS
/******************************************************************************
File: usp_Get_Strategy_DirectorSubscribeSPP.sql
Stored Procedure Name: usp_Get_Strategy_DirectorSubscribeSPP
Overview
-----------------
usp_Get_Strategy_DirectorSubscribeSPP
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_Get_Strategy_DirectorSubscribeSPP'
