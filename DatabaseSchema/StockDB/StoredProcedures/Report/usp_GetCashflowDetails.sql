-- Stored procedure: [Report].[usp_GetCashflowDetails]



CREATE PROCEDURE [Report].[usp_GetCashflowDetails]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT,
@pvchStockCode as varchar(10) = null
AS
/******************************************************************************
File: usp_GetCashflowDetails.sql
Stored Procedure Name: usp_GetCashflowDetails
Overview
-----------------
usp_GetCashflowDetails
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_GetCashflowDetails'
