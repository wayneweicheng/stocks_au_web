-- Stored procedure: [Report].[usp_Get_Strategy_BrokerNewBuy]



CREATE PROCEDURE [Report].[usp_Get_Strategy_BrokerNewBuy]
@pbitDebug AS BIT = 0, 
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_Get_Strategy_BrokerNewBuy'
