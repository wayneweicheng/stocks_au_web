-- Stored procedure: [Report].[usp_Get_ASXStockPredictUSIndex]



CREATE PROCEDURE [Report].[usp_Get_ASXStockPredictUSIndex]
@pbitDebug AS BIT = 0,
...
AS
/******************************************************************************
File: usp_Get_ASXStockPredictUSIndex.sql
Stored Procedure Name: usp_Get_ASXStockPredictUSIndex
Overview
-----------------
usp_Get_ASXStockPredictUSIndex
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_Get_ASXStockPredictUSIndex'
