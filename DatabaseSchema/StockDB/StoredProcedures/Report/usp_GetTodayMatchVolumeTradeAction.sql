-- Stored procedure: [Report].[usp_GetTodayMatchVolumeTradeAction]


CREATE PROCEDURE [Report].[usp_GetTodayMatchVolumeTradeAction]
@pbitDebug AS BIT = 0,
@pvchASXCode varchar(10),
@pdtObservationDate date = null,
@pdecIndicativePrice decimal(20, 4) = null,
@pintMatchVolume int = null,
@pbitReturnValue as bit = 1,
@pintErrorNumber AS INT = 0 OUTPUT
AS
/******************************************************************************
File: usp_GetTodayMatchVolumeTradeAction.sql
Stored Procedure Name: usp_GetTodayMatchVolumeTradeAction
Overview
-----------------
usp_GetTodayMatchVolumeTradeAction
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		if @pbitDebug = 1
		begin
			select 'Y' as TradeAction, cast(2000 as decimal(20, 4)) as TradeValue
			return
		end
		...
		begin
			...
			select
				...
				if @pbitReturnValue = 1
				begin
					select 'S' as TradeAction, cast(10000 as decimal(20, 4)) as TradeValue
				end
		...
		if @pbitReturnValue = 1
		begin
			select 'N' as TradeAction, cast(0 as decimal(20, 4)) as TradeValue
		end	
