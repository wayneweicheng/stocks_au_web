-- Stored procedure: [Report].[usp_GetCurrentWatchs]



CREATE PROCEDURE [Report].[usp_GetCurrentWatchs]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT,
@pintNumPrevDay as int = 0
AS
/******************************************************************************
File: usp_GetCurrentWatchs.sql
Stored Procedure Name: usp_GetCurrentWatchs
Overview
-----------------
usp_GetCurrentWatchs
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_GetCurrentWatchs'
