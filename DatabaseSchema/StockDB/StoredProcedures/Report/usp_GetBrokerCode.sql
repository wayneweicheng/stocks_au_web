-- Stored procedure: [Report].[usp_GetBrokerCode]



CREATE PROCEDURE [Report].[usp_GetBrokerCode]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		(
			...
			select 
				'All' as BrokerCode,
				'All Brokers' as BrokerName,
				1 as RankOrder
		) as x
		order by RankOrder, BrokerCode
