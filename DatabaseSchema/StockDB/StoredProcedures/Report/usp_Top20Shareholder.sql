	...
	BEGIN TRY
		...
		(
			select 
				...
				a.[CurrRank],
				a.[PrevRank],
				format(a.[CurrShares], 'N0') as [CurrShares],
				format(a.[PrevShares], 'N0') as [PrevShares],
				a.[CurrSharesPerc],
				a.[PrevSharesPerc],
				...
				b.ReportPeriod,
				c.RecentPerformance as LongTermPerformance,
			...
			select 
				...
				'Top 20 In Total' as ShareHolder,
				a.[CurrDate],
				a.[PrevDate],
				999 as [CurrRank],
				null as [PrevRank],
				format(sum(a.[CurrShares]), 'N0') as [CurrShares],
				format(sum(a.[PrevShares]), 'N0') as [PrevShares],
