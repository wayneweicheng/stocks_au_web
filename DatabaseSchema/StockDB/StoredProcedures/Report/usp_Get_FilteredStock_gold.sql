-- Stored procedure: [Report].[usp_Get_FilteredStock_gold]




create PROCEDURE [Report].[usp_Get_FilteredStock_gold]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT
AS
/******************************************************************************
File: [usp_Get_FilteredStock_gold].sql
Stored Procedure Name: [usp_Get_FilteredStock_gold]
Overview
-----------------
[usp_Get_FilteredStock_gold]
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = '[usp_Get_FilteredStock_gold]'
