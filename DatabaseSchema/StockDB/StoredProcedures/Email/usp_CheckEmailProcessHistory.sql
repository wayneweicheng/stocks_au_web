-- Stored procedure: [Email].[usp_CheckEmailProcessHistory]


CREATE PROCEDURE [Email].[usp_CheckEmailProcessHistory]
@pbitDebug AS BIT = 0,
...
AS
/******************************************************************************
File: usp_CheckEmailProcessHistory.sql
Stored Procedure Name: usp_CheckEmailProcessHistory
Overview
-----------------
usp_CheckEmailProcessHistory
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_CheckEmailProcessHistory'
