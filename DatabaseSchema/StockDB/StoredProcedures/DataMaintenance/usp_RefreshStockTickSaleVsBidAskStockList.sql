-- Stored procedure: [DataMaintenance].[usp_RefreshStockTickSaleVsBidAskStockList]





CREATE PROCEDURE [DataMaintenance].[usp_RefreshStockTickSaleVsBidAskStockList]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		if object_id(N'Transform.StockTickSaleVsBidAskStockList') is not null
			drop table Transform.StockTickSaleVsBidAskStockList

		select distinct ASXCode
		into Transform.StockTickSaleVsBidAskStockList
