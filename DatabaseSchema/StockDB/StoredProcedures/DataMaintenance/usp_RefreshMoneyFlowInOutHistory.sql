-- Stored procedure: [DataMaintenance].[usp_RefreshMoneyFlowInOutHistory]



CREATE PROCEDURE [DataMaintenance].[usp_RefreshMoneyFlowInOutHistory]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT
AS
/******************************************************************************
File: usp_RefreshMoneyFlowInOutHistory.sql
Stored Procedure Name: usp_RefreshMoneyFlowInOutHistory
Overview
-----------------
usp_RefreshMoneyFlowInOutHistory
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_RefreshMoneyFlowInOutHistory'
