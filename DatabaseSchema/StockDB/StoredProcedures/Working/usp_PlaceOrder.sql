-- Stored procedure: [Working].[usp_PlaceOrder]


create PROCEDURE [Working].[usp_PlaceOrder]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		--sell
		exec master.dbo.xp_cmdshell 'C:\\Application\\PythonTrade\\SellStock.py -s CAJ -a 305348 -q 30000 -p 0.29';

		--buy
		exec master.dbo.xp_cmdshell 'C:\\Application\\PythonTrade\\BuyStock.py -s PLS -a 305348 -q 12000 -p 0.26';
