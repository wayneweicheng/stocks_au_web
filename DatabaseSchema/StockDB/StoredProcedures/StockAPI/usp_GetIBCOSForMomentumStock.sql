-- Stored procedure: [StockAPI].[usp_GetIBCOSForMomentumStock]


CREATE PROCEDURE [StockAPI].[usp_GetIBCOSForMomentumStock]
@pbitDebug AS BIT = 0,
@pdtObservationDate as date,
@pintErrorNumber AS INT = 0 OUTPUT
AS
/******************************************************************************
File: usp_GetIBMarketDepthForStock.sql
Stored Procedure Name: usp_GetIBMarketDepthForStock
Overview
-----------------
usp_GetIBMarketDepthForStock
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_GetIBCOSForMomentumStock'
		...
		--Code goes here 
		--begin transaction
		--declare @pdtObservationDate as date = '2022-07-22'
