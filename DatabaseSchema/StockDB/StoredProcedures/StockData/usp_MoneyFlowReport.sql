-- Stored procedure: [StockData].[usp_MoneyFlowReport]





CREATE PROCEDURE [StockData].[usp_MoneyFlowReport]
@pbitDebug AS BIT = 0,
		...
		begin
			...
			select
				...
				case when b.BrokerScore >= 1.2 then 'StrongBroker' 
					 when b.BrokerScore >= 0.6 and b.BrokerScore < 1.2 then 'StrongBroker'
