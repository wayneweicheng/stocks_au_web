...
BEGIN --Proc
	...
	BEGIN TRY
		...
		update a
		set ObservationDateLocal = cast(CONVERT(datetime, SWITCHOFFSET(ObservationTime, DATEPART(TZOFFSET, ObservationTime AT TIME ZONE 'AUS Eastern Standard Time'))) as date)
