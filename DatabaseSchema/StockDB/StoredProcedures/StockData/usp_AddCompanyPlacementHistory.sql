...
BEGIN --Proc
	...
	BEGIN TRY
		...
		--declare @pvchASXCode as varchar(100) = 'AX8.AX'
		--declare @pvchCompanyInfo as varchar(max) = '{"ASXCode": "AX8", "CapitalRaiseHistoryUrl": "https://www.freshequities.com/ASX/AX8/capital-raises", "PlacementHistory": [{"PlaceDate": "13 Sep 2021", "RaisedAmount": "$3.1m", "OfferPrice": "$0.036", "Discount": "14.29%", "MarketCapAtRaise": "$6.59m"}, {"PlaceDate": "1 Sep 2020", "RaisedAmount": "$1.7m", "OfferPrice": "$0.05", "Discount": "10.71%", "MarketCapAtRaise": "$5.56m"}, {"PlaceDate": "9 Jul 2020", "RaisedAmount": "$1m", "OfferPrice": "$0.0288", "Discount": "10%", "MarketCapAtRaise": "$2.54m"}, {"PlaceDate": "23 Jan 2020", "RaisedAmount": "$120.42k", "OfferPrice": "$0.0225", "Discount": "12.32%", "MarketCapAtRaise": "$1.53m"}]}'
		...
		and len(try_cast(replace(OfferPrice, '$', '') as decimal(20, 4))) > 0;
