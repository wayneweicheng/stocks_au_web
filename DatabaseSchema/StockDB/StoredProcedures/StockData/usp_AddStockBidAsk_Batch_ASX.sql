-- Stored procedure: [StockData].[usp_AddStockBidAsk_Batch_ASX]




CREATE PROCEDURE [StockData].[usp_AddStockBidAsk_Batch_ASX]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_AddStockBidAsk_Batch_ASX'
		...
		insert into [StockData].[StockBidAskASX]
		(
		   ASXCode
		  ,ObservationTime
		  ,ObservationDate
