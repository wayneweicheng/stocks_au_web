-- Stored procedure: [StockData].[usp_GetStrongBuy_By_Stock]




CREATE PROCEDURE [StockData].[usp_GetStrongBuy_By_Stock]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT,
@pvchASXCode varchar(10)
AS
/******************************************************************************
File: usp_GetStrongBuy_By_Stock.sql
Stored Procedure Name: usp_GetStrongBuy_By_Stock
Overview
-----------------
usp_GetStrongBuy_By_Stock
...
Example of use
-----------------
exec [StockData].[usp_GetStrongBuy_By_Stock]
@pvchASXCode = 'PAR.AX',
@pbitDebug = 0
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_GetStrongBuy_By_Stock'
		...
		left join StockData.PriceHistory as z
