-- Stored procedure: [StockData].[usp_GetFirstBuySell_dev]




create PROCEDURE [StockData].[usp_GetFirstBuySell_dev]
@pbitDebug AS BIT = 0,
...
--select cast(ObservationDateTime as smalldatetime), sum(cast(replace(Bid1VolumeDelta, '','', '''') as int)) as BidChanges
