-- Stored procedure: [StockData].[usp_MoneyFlowReportInstituteIntraday]
...
CREATE PROCEDURE [StockData].[usp_MoneyFlowReportInstituteIntraday]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		select
			min(a.CourseOfSaleSecondaryID) as CourseOfSaleID,
			a.SaleDateTime,
			a.Price,
