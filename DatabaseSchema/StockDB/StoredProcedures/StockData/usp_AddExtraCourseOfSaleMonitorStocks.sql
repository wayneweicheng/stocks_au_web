-- Stored procedure: [StockData].[usp_AddExtraCourseOfSaleMonitorStocks]



CREATE PROCEDURE [StockData].[usp_AddExtraCourseOfSaleMonitorStocks]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT
AS
/******************************************************************************
File: usp_AddExtraCourseOfSaleMonitorStocks.sql
Stored Procedure Name: usp_AddExtraCourseOfSaleMonitorStocks
Overview
-----------------
usp_AddExtraCourseOfSaleMonitorStocks
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_AddExtraCourseOfSaleMonitorStocks'
