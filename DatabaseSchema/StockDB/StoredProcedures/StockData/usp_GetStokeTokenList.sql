-- Stored procedure: [StockData].[usp_GetStokeTokenList]
...
CREATE PROCEDURE [StockData].[usp_GetStokeTokenList]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT,
@pvchToken varchar(200)
AS
/******************************************************************************
File: usp_GetStokeTokenList.sql
Stored Procedure Name: usp_GetStokeTokenList
Overview
-----------------
usp_GetStokeTokenList
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_GetStokeTokenList'
		...
		select
		  ...
		  ,b.[Close] as [Last]
		  ,c.[Close] as [Close]
		  ,cast((b.[Close] - c.[Close])*100.0/c.[close] as decimal(10, 2)) as ChangePerc
