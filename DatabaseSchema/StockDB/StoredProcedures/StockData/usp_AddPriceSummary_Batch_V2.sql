-- Stored procedure: [StockData].[usp_AddPriceSummary_Batch_V2]


CREATE PROCEDURE [StockData].[usp_AddPriceSummary_Batch_V2]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		select
			...
			cast([Hash] as bigint) as HashValue
