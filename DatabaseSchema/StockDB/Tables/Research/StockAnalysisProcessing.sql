...
,
    CONSTRAINT [PK_StockAnalysisProcessing] PRIMARY KEY (ProcessingID)
);
...
CREATE UNIQUE INDEX [IX_StockAnalysisProcessing_StockCode_ObservationDate_Active] ON [Research].[StockAnalysisProcessing] (StockCode, ObservationDate);