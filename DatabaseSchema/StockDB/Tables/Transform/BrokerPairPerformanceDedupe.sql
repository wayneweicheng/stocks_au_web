-- Table: [Transform].[BrokerPairPerformanceDedupe]

CREATE TABLE [Transform].[BrokerPairPerformanceDedupe] (
...
,
    CONSTRAINT [pk_transform_BrokerPairPerformanceDedupe_brokerpairperformanceid] PRIMARY KEY (BrokerPairPerformanceID)
);
