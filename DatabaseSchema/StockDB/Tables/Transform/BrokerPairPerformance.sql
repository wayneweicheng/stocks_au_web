-- Table: [Transform].[BrokerPairPerformance]

CREATE TABLE [Transform].[BrokerPairPerformance] (
    ...
    [DedupeKey] [int] NULL
,
    CONSTRAINT [pk_transform_brokerpairperformance_brokerpairperformanceid] PRIMARY KEY (BrokerPairPerformanceID)
);
