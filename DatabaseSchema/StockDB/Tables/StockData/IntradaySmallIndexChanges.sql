-- Table: [StockData].[IntradaySmallIndexChanges]

CREATE TABLE [StockData].[IntradaySmallIndexChanges] (
...
CREATE INDEX [idx_stockdataintradaysmallindexchanges_obdateobtime] ON [StockData].[IntradaySmallIndexChanges] (ObservationDate, ObservationTime);