-- Table: [StockData].[CompanyInfoHistory]

CREATE TABLE [StockData].[CompanyInfoHistory] (
    [CompanyInfoHistoryID] [bigint] IDENTITY(1,1) NOT NULL,
...
,
    CONSTRAINT [pk_stockdata_companyinfo_companyinfohistoryid] PRIMARY KEY (CompanyInfoHistoryID)
);
