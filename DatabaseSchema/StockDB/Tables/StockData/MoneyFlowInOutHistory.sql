-- Table: [StockData].[MoneyFlowInOutHistory]

CREATE TABLE [StockData].[MoneyFlowInOutHistory] (
...
,
    CONSTRAINT [pk_stockdata_moneyflowinouthistory_uniquekey] PRIMARY KEY (UniqueKey)
);
