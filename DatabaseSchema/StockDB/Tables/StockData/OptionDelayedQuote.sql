-- Table: [StockData].[OptionDelayedQuote]

CREATE TABLE [StockData].[OptionDelayedQuote] (
...
CREATE INDEX [idx_stockdataoptiondelayedquote_asxcodeobservationdate] ON [StockData].[OptionDelayedQuote] (ASXCode, ObservationDate);