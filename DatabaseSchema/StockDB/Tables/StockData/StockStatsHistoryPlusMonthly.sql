-- Table: [StockData].[StockStatsHistoryPlusMonthly]

CREATE TABLE [StockData].[StockStatsHistoryPlusMonthly] (
...
,
    CONSTRAINT [pk_stockdata_stockstatshistoryplusmonthly_uniquekey] PRIMARY KEY (UniqueKey)
);
