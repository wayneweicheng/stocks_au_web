-- Table: [StockData].[StockStatsHistoryPlusWeekly]

CREATE TABLE [StockData].[StockStatsHistoryPlusWeekly] (
...
,
    CONSTRAINT [pk_stockdata_stockstatshistoryplusweekly_uniquekey] PRIMARY KEY (UniqueKey)
);
