...
CREATE TABLE [StockData].[PlaceHistory] (
    ...
    [LeadManager1] [varchar](200) NULL,
    [LeadManager2] [varchar](200) NULL,
    [AccessedBy180] [bit] NULL,
    [AccessedByFE] [bit] NULL,
    [FirstTrenchReleaseDate] [date] NULL,
    [SecondTrenchReleaseDate] [date] NULL
,
