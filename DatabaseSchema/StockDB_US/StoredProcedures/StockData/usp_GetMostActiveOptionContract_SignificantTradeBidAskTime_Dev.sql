-- Stored procedure: [StockData].[usp_GetMostActiveOptionContract_SignificantTradeBidAskTime_Dev]



create PROCEDURE [StockData].[usp_GetMostActiveOptionContract_SignificantTradeBidAskTime_Dev]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		--Code goes here		
		--declare @pvchOptionSymbol as varchar(100) = 'SPY230414C00412000'
		--declare @pvchObservationDate as varchar(50) = '2023-04-13'
		...
		select OptionTradeID, ASXCode, OptionSymbol, dateadd(second, -20, SaleTime) as StartDateTime, dateadd(second, 20, SaleTime) as EndDateTime, SaleTime, OptionTradeID as GroupID
