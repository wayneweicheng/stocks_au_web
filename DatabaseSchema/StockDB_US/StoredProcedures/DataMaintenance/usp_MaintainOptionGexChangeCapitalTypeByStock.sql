-- Stored procedure: [DataMaintenance].[usp_MaintainOptionGexChangeCapitalTypeByStock]
...
CREATE PROCEDURE [DataMaintenance].[usp_MaintainOptionGexChangeCapitalTypeByStock]
@pbitDebug AS BIT = 0,
