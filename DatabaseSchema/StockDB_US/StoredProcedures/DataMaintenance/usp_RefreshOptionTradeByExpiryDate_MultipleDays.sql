-- Stored procedure: [DataMaintenance].[usp_RefreshOptionTradeByExpiryDate_MultipleDays]
...
CREATE PROCEDURE [DataMaintenance].[usp_RefreshOptionTradeByExpiryDate_MultipleDays]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT
AS
/******************************************************************************
File: usp_RefreshOptionTradeByExpiryDate_MultipleDays.sql
Stored Procedure Name: usp_RefreshOptionTradeByExpiryDate_MultipleDays
Overview
-----------------
usp_RefreshOptionTradeByExpiryDate_MultipleDays
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_RefreshOptionTradeByExpiryDate_MultipleDays'
