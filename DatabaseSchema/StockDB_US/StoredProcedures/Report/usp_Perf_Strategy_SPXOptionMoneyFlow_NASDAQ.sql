-- Stored procedure: [Report].[usp_Perf_Strategy_SPXOptionMoneyFlow_NASDAQ]


CREATE PROCEDURE [Report].[usp_Perf_Strategy_SPXOptionMoneyFlow_NASDAQ]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT
AS
/******************************************************************************
File: usp_Perf_Strategy_SPXOptionMoneyFlow_NASDAQ.sql
Stored Procedure Name: usp_Perf_Strategy_SPXOptionMoneyFlow_NASDAQ
Overview
-----------------
usp_Perf_Strategy_SPXOptionMoneyFlow_NASDAQ
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_Perf_Strategy_SPXOptionMoneyFlow_NASDAQ'
