-- Stored procedure: [Report].[usp_Get_Strategy_NormMFRankLong]


CREATE PROCEDURE [Report].[usp_Get_Strategy_NormMFRankLong]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		--select 
		--	'Norm MF Rank Long' as ReportType,			
		--	MFRankPerc,
		--	--a.ASXCode, 
		...
		and NumObs > 30
		and ObservationDate = @dtObservationDate
		order by ObservationDate desc, ZScoreGEXDelta desc;
