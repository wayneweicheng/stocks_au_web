...
BEGIN --Proc
	...
	BEGIN TRY
		...
		declare @dtMaxBRDate as date
		select @dtMaxBRDate = [Common].[DateAddBusinessDay](-1 * 2 - @pintNumPrevDay, @dtMaxDate)
		...
		begin
			select @dtMaxBRDate = '2050-01-01'
		end

		exec [Report].[usp_Get_HighWinPairBrokerSetup]
		@pdtObservationDate = @dtMaxBRDate,
		@pbitFilterByPreviousPerformance = 1
