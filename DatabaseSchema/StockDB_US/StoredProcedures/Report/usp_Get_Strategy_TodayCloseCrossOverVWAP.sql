...
BEGIN --Proc
	...
	BEGIN TRY
		...
		inner join #TempMFResult as d
		on d.ASXCode = a.ASXCode
		and d.RowNumber = a.RowNumber + 1
		and try_cast(d.[VWAP] as decimal(20, 4)) > try_cast(a.VWAP as decimal(20, 4))
		inner join #TempMFResult as e
		on e.ASXCode = d.ASXCode
		and e.RowNumber = d.RowNumber + 1
		and try_cast(e.[VWAP] as decimal(20, 4)) > try_cast(d.VWAP as decimal(20, 4))
		inner join [StockData].[StockStatsHistoryPlusCurrent] as c
		on a.ASXCode = c.ASXCode
		--and a.MarketDate = c.ObservationDate
		--and try_cast(b.[Close] as decimal(20, 4)) > c.MovingAverage30d
		--and try_cast(replace(b.Volume, ',', '') as bigint) > c.MovingAverage30dVol
