-- Stored procedure: [Report].[usp_Get_Strategy_WeeklyTop51To100]


CREATE PROCEDURE [Report].[usp_Get_Strategy_WeeklyTop51To100]
@pbitDebug AS BIT = 0,
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		select 
			'Weekly Top 51to100' as ReportType,			
			TimeFrame,
			--a.ASXCode, 
