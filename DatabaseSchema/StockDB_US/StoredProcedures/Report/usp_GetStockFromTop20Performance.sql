...
--@pintDaysGoBack = 120,
--@pvchShareHolder = 'Lowell Resources Funds Management Pty. Ltd.'
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		begin
			select cast(c.StartObservationDate as date) as StartObservationDate, 'Top20 Stocks' as ReportType, c.ASXCode, cast(c.EndObservationDate as date) as EndObservationDate, e.*, c.EndClose, c.StartClose, c.[PriceIncrease%], c.MC, c.CashPosition, c.Nature, c.Poster, cast(d.MedianTradeValue as int) as MedianTradeValue, cast(d.MedianTradeValueDaily as int) as MedianTradeValueDaily
