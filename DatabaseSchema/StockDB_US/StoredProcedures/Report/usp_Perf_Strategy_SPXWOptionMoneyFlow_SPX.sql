-- Stored procedure: [Report].[usp_Perf_Strategy_SPXWOptionMoneyFlow_SPX]


CREATE PROCEDURE [Report].[usp_Perf_Strategy_SPXWOptionMoneyFlow_SPX]
@pbitDebug AS BIT = 0,
@pintErrorNumber AS INT = 0 OUTPUT
AS
/******************************************************************************
File: usp_SPXOptionMoneyFlow_Perf_SPX.sql
Stored Procedure Name: usp_SPXOptionMoneyFlow_Perf_SPX
Overview
-----------------
usp_SPXWOptionMoneyFlow_Perf_SPX
...
BEGIN --Proc
	...
	BEGIN TRY
		...
		DECLARE @vchProcedureName AS VARCHAR(100);		SET @vchProcedureName = 'usp_SPXWOptionMoneyFlow_Perf_SPX'
		...
		where a.ASXCode = 'SPXL.US'
		and b.ASXCode = 'SPXS.US'
