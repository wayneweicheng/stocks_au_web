-- View: [Transform].[v_SPYOptionMoneyFlow]
...
CREATE view [Transform].[v_SPYOptionMoneyFlow]
as
select 
	*,
...
(
	select 
		...
		case when b.ShortLongRatio > a.ShortLongRatio*1.01 and b.ShortLongRatio > 1 and isnull(abs(cast(b.ShortMinusLongGEX*100.0/b.ShortGEX as decimal(10, 2))), 5) > 2.5 then 'Swing down' 
			 when b.ShortLongRatio > a.ShortLongRatio*0.99 and b.ShortLongRatio > 1.03 and isnull(abs(cast(b.ShortMinusLongGEX*100.0/b.ShortGEX as decimal(10, 2))), 5) > 2.5 then 'Swing down' 
			 when b.ShortLongRatio < a.ShortLongRatio*0.99 and b.ShortLongRatio < 1 and isnull(abs(cast(b.ShortMinusLongGEX*100.0/b.ShortGEX as decimal(10, 2))), 5) > 2.5 then 'Swing Up' 
			 when b.ShortLongRatio < a.ShortLongRatio*1.01 and b.ShortLongRatio < 0.97 and isnull(abs(cast(b.ShortMinusLongGEX*100.0/b.ShortGEX as decimal(10, 2))), 5) > 2.5 then 'Swing Up' 
		else 'No Signal'
