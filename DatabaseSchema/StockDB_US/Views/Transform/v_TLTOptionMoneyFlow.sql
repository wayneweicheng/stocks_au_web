-- View: [Transform].[v_TLTOptionMoneyFlow]



CREATE view [Transform].[v_TLTOptionMoneyFlow]
as
select 
	*,
...
(
	...
	left join StockDB_US.StockData.v_PriceHistory as d
	on a.ObservationDate = d.ObservationDate
	and d.ASXCode = 'TLT.US'
	where a.ObservationDate >= '2022-10-13'
	and a.ASXCode = 'TLT.US'
) as x
