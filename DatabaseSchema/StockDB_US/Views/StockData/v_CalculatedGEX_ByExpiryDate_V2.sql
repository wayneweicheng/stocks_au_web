-- View: [StockData].[v_CalculatedGEX_ByExpiryDate_V2]
...
CREATE view [StockData].[v_CalculatedGEX_ByExpiryDate_V2]
as
select 
	a.ASXCode, 
	a.ObservationDate,
...
group by a.ASXCode, a.ObservationDate, b.[Close], a.ExpiryDate
