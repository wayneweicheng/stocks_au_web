...
CREATE INDEX [idx_stockdata_pricesummary] ON [StockData].[PriceSummary] (ObservationDate);
...
CREATE INDEX [idx_stockdatapricesummary_datetoobservationdateasxcode] ON [StockData].[PriceSummary] (DateTo, ObservationDate, ASXCode);
...
CREATE INDEX [idx_stockdatapricesummary_observationdate] ON [StockData].[PriceSummary] (ObservationDate);
