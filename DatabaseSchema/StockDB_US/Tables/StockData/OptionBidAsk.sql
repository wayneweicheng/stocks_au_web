...
CREATE INDEX [idx_stockdata_optionbidask_obdatelocaloptionsymbol] ON [StockData].[OptionBidAsk] (ObservationDateLocal, OptionSymbol);
CREATE INDEX [idx_stockdata_optionbidask_obtime] ON [StockData].[OptionBidAsk] (OptionSymbol, PriceBid, PriceAsk, ObservationTime);