-- Table: [StockData].[OptionDelayedQuote_V2]

CREATE TABLE [StockData].[OptionDelayedQuote_V2] (
...
CREATE INDEX [idx_stockdatadelayedquotev2_obdateasxcodeIncsymbol] ON [StockData].[OptionDelayedQuote_V2] (OptionSymbol, ObservationDate, ASXCode);
CREATE INDEX [idx_stockdataoptiondelayedquotev2_asxcodeobservationdate] ON [StockData].[OptionDelayedQuote_V2] (ASXCode, ObservationDate);