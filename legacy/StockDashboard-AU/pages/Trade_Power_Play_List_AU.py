...
if authentication_status:
    ...
    if date_from and date_to:
        ...
        from StockTickSummary as inb
        inner join StockTickSummary as reb
        on inb.ASXCode = reb.ASXCode
        inner join StockTickSummary as ins
        on ins.ASXCode = inb.ASXCode
        inner join StockTickSummary as res
        ...
        """
        sql_data = obj_sql_server_model.execute_read_query(sql, (date_from, date_to))
